...
export default function handler(req, res) {
    ...
    formData.append("raw", "Example  ${random} to get what the is supposed to be posted" );
    formData.append("title", `Example ${random} to get what the is supposed to be  ${random} posted` );
   //  var formData = {
